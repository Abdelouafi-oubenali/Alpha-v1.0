...
<head>
    ...
    <title>Alpha v1.0 - Gestion d'Entreprise</title>
                ...
                <div class="flex items-center justify-between h-16">
                    ...
                    <div class="hidden md:block">
                        <div class="ml-4 flex items-center md:ml-6">
                            <button type="button" class="p-1 rounded-full text-gray-200 hover:text-white focus:outline-none">
                            ...
                            <div class="ml-3 relative">
                                <div>
                                    <button type="button" class="max-w-xs bg-blue-800 rounded-full flex items-center text-sm focus:outline-none" id="user-menu-button">
